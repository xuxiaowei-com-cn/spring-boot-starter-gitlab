...
public class GitLabAuthenticationToken extends AbstractAuthenticationToken {
	...
	public GitLabAuthenticationToken(Collection<? extends GrantedAuthority> authorities, Authentication clientPrincipal,
		...
		this.authorizationGrantType = OAuth2GitLabAuthenticationToken.GITLAB;
