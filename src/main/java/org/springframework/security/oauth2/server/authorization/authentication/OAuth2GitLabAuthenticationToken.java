...
public class OAuth2GitLabAuthenticationToken extends OAuth2AuthorizationGrantAuthenticationToken {
	 ...
	 * 授权类型：GitLab
	 */
	public static final AuthorizationGrantType GITLAB = new AuthorizationGrantType("gitlab");
	 ...
	 */
	public OAuth2GitLabAuthenticationToken(Authentication clientPrincipal, Map<String, Object> additionalParameters,
